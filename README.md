...
- REMOVED: Search posts with [Fuse.js](https://fusejs.io) and [vue-fuse](https://github.com/shayneo/vue-fuse)
- Tags for posts
- Basic pagination
...
## GW TODO
Search for `style="display: none"` for hidden elements

`.env` file needs to be in Root folder (same as `package.json`)